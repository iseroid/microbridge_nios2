...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../mb_de0nano.jdi
...
# Design Name 
# setting SOPC_NAME is mb_de0nano_sopc
SOPC_NAME := mb_de0nano_sopc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8020
SOPC_SYSID_FLAG += --sidp=0x8020
ELF_PATCH_FLAG  += --sidp 0x8020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1322037390
SOPC_SYSID_FLAG += --timestamp=1322037390
ELF_PATCH_FLAG  += --timestamp 1322037390
